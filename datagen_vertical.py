...
datafile = open('C:\\bigData\\CodeSamplesEtc\\FRTB\\demo\\verticalData_x.csv', 'w')
transformedDatafile = open('C:\\bigData\\CodeSamplesEtc\\FRTB\\demo\\transformedVerticalData_x.csv', 'w')
...
prodDescFile = open('C:\\bigData\\CodeSamplesEtc\\FRTB\\demo\\product_descriptions.csv', 'w')

for idx in range(1,len(product_ids)):
